...
As part of the Contoso Sample Data that has been deployed, you should have multiple knowledge articles that are deployed and published. If you do not have any articles, or you would like to create an article specific to certain use cases, customers, or scenarios, follow the information below.
...
1. At the top right of the page, select your demo environment.
    ...
    ![Demo environment selector](../../media/8d11toyb.jpg)

1. In the left pane, select **Apps**.

    ![Apps in left pane](../../media/x27iv0xo.jpg)

1. On the command bar, select **All**.

    ![All apps](../../media/fw9shrup.jpg)

1. Select the **Copilot Service workspace** app and then select **Play** to launch the app.

    ![Copilot Service workspace app](../../media/bz7ng3sp.jpg)

1. At the top left of the page, select **Site map** and then select **Knowledge Articles**.

    ![Knowledge Articles in site map](../../media/0dw5tz9y.jpg)

1. In the command bar, select **+ New**.

    ![New knowledge article](../../media/k07lyyt5.jpg)
...
1. Configure the knowledge article by using the following information:
    ...
    ![Knowledge article form](../../media/jwn42kgi.jpg)
...
1. On the command bar, select **Approve**.
    ...
    ![Approve button](../../media/6czk2f6i.jpg)
...
1. Locate and then select the English version of the **Loud Noise** article.
    ...
    ![English Loud Noise article](../../media/ua0p77fx.jpg)

1. On the command bar, select **Publish**.

    ![Publish button](../../media/5i10bhvv.jpg)
...
1. Configure the publication by using the following values and then select **Publish**:
    ...
    ![Publish configuration](../../media/gll5k09k.jpg)

    ![Publish confirmation](../../media/dncu5ha2.jpg)
